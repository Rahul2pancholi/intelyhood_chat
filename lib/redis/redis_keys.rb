module Redis::RedisKeys
  ...
  INTELYCHAT_INSTALLATION_ONBOARDING = 'INTELYCHAT_INSTALLATION_ONBOARDING'.freeze
  INTELYCHAT_INSTALLATION_CONFIG_RESET_WARNING = 'INTELYCHAT_CONFIG_RESET_WARNING'.freeze
  LATEST_INTELYCHAT_VERSION = 'LATEST_INTELYCHAT_VERSION'.freeze
