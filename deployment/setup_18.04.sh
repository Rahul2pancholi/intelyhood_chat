...
# Description: Intelychat installation script
# OS: Ubuntu 18.04 LTS
# Script Version: 0.2
...
adduser --disabled-login --gecos "" intelychat

sudo -i -u intelychat bash << EOF
...
echo "Woot! Woot!! Intelychat server installation is complete"
