class SuperAdmin::AppConfigsController < SuperAdmin::ApplicationController
  ...
  def allowed_configs
    mapping = {
      ...
      'captain' => %w[CAPTAIN_LLM_PROVIDER CAPTAIN_OPEN_AI_API_KEY CAPTAIN_OPEN_AI_MODEL CAPTAIN_OPEN_AI_ENDPOINT CAPTAIN_GEMINI_API_KEY]
    }
  ...
  def success_notice
    ...
    "#{message.delete_suffix('.')}. Restart Intelychat web and worker processes to apply this change everywhere."
  end
