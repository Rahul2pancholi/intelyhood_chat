class Api::V1::Accounts::InboxesController < Api::V1::Accounts::BaseController
  ...
  def ensure_within_inbox_limit!
    subscription = Current.account.subscription
    return if subscription.nil? || subscription.within_inbox_limit?

    raise CustomExceptions::Inbox::LimitExceeded, {}
  end
  ...
  def permitted_params(channel_attributes = [])
    # We will remove this line after fixing https://linear.app/intelychat/issue/CW-1567/null-value-passed-as-null-string-to-backend
