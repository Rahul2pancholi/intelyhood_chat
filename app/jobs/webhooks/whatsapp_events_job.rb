class Webhooks::WhatsappEventsJob < MutexApplicationJob
  ...
  # Intelychat and the WhatsApp Business app, with messages synced to Intelychat.
  #
  ...
  def find_channel_from_whatsapp_business_payload(params)
    # for the case where facebook cloud api supports multiple numbers for a single app
