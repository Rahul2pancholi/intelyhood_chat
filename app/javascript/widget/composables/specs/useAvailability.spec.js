...
describe('useAvailability', () => {
  const originalWindow = window.intelychatWebChannel;
  ...
  afterEach(() => {
    window.intelychatWebChannel = originalWindow;
  });
  ...
  describe('config changes', () => {
    it('should react to window.intelychatWebChannel changes', () => {
