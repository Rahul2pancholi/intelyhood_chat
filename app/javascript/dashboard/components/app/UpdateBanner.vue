...
export default {
  components: { Banner },
  props: {
    latestIntelychatVersion: { type: String, default: '' },
  },
  setup() {
  ...
  computed: {
    ...
    updateAvailable() {
      return hasAnUpdateAvailable(
        this.latestIntelychatVersion,
        this.globalConfig.appVersion
      );
    },
    bannerMessage() {
      return this.$t('GENERAL_SETTINGS.UPDATE_CHATWOOT', {
        latestIntelychatVersion: this.latestIntelychatVersion,
      });
    },
    shouldShowBanner() {
      return (
        ...
        !this.isVersionNotificationDismissed(this.latestIntelychatVersion) &&
        this.isAdmin
      );
    },
  },
  methods: {
    ...
    dismissUpdateBanner() {
      ...
      if (updatedDismissedItems instanceof Array) {
        updatedDismissedItems.push(this.latestIntelychatVersion);
      } else {
        updatedDismissedItems = [this.latestIntelychatVersion];
      }
      LocalStorage.set(
