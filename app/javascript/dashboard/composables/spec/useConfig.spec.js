...
describe('useConfig', () => {
  const originalChatwootConfig = window.intelychatConfig;
  ...
  afterEach(() => {
    window.intelychatConfig = originalChatwootConfig;
  });
  ...
  it('handles undefined window.intelychatConfig', () => {
    window.intelychatConfig = undefined;
    const config = useConfig();
