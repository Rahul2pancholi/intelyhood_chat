...
export const documentsList = [
  {
    ...
    id: 3059,
    name: 'How to use Conversation Filters? | User Guide | Intelychat',
    status: 'available',
  },
  {
    account_id: 2,
    ...
    content:
      'Step-by-step guide for automating ticket assignments and improving support workflow in Intelychat.',
    created_at: 1736143273,
    external_link:
      'https://www.chatwoot.com/hc/user-guide/articles/1677688200-automating-ticket-assignments',
    id: 3060,
    name: 'Automating Ticket Assignments | User Guide | Intelychat',
    status: 'available',
  },
  {
    account_id: 3,
    ...
    id: 3061,
    name: 'Managing Customer Profiles | User Guide | Intelychat',
    status: 'available',
  },
  {
    account_id: 4,
    ...
    id: 3062,
    name: 'Sales Tracking Guide | User Guide | Intelychat',
    status: 'available',
  },
  {
    account_id: 5,
    ...
    content:
      'How to efficiently create, manage, and resolve tickets in Intelychat.',
    created_at: 1736143276,
    external_link:
      'https://www.chatwoot.com/hc/user-guide/articles/1677688230-managing-tickets',
    id: 3063,
    name: 'Managing Tickets | User Guide | Intelychat',
    status: 'available',
  },
  {
    account_id: 6,
    ...
    id: 3064,
    name: 'Financial Reporting | User Guide | Intelychat',
    status: 'available',
  },
];
...
export const responsesList = [
  {
    ...
    id: 87,
    question: 'Why is my Messenger in Intelychat deactivated?',
    status: 'pending',
    assistant: {
      account_id: 1,
      config: { product_name: 'Intelychat' },
  ...
  },
  {
    ...
    id: 88,
    question: 'How do I integrate WhatsApp with Intelychat?',
    assistant: {
      account_id: 2,
      config: { product_name: 'Intelychat' },
  ...
  },
  {
    ...
    id: 89,
    question: 'How can I reset my password in Intelychat?',
    assistant: {
      account_id: 3,
      config: { product_name: 'Intelychat' },
  ...
  },
  {
    ...
    id: 90,
    question: 'How do I enable dark mode in Intelychat?',
    assistant: {
      account_id: 4,
      config: { product_name: 'Intelychat' },
  ...
  },
  {
    ...
    id: 91,
    question: 'How do I add a new team member in Intelychat?',
    assistant: {
      account_id: 5,
      config: { product_name: 'Intelychat' },
  ...
  },
  {
    account_id: 6,
    answer:
      "Campaigns in Intelychat allow you to send targeted messages to specific user segments. You can create them in the 'Campaigns' section.",
    created_at: 1736283380,
    id: 92,
    question: 'What are campaigns in Intelychat?',
    assistant: {
      account_id: 6,
      config: { product_name: 'Intelychat' },
