...
const isAnIntelychatInstance = getters['globalConfig/isAnIntelychatInstance'];
...
const emailProviderList = computed(() => {
  return [
    ...
    },
    {
      ...
      isEnabled: !!window.intelychatConfig.googleOAuthClientId,
      key: 'google',
      icon: 'i-woot-gmail',
    },
    {
    ...
    if (isAnIntelychatInstance.value) {
      return true;
    }
