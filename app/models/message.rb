...
class Message < ApplicationRecord
  searchkick callbacks: false if IntelychatApp.advanced_search_allowed?
  ...
  def should_index?
    return false unless IntelychatApp.advanced_search_allowed?
    return false unless incoming? || outgoing?
    # For Intelychat Cloud:
    ...
    return false if IntelychatApp.intelychat_cloud? && !account.feature_enabled?('advanced_search_indexing')
