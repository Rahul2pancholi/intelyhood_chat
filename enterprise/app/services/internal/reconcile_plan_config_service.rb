class Internal::ReconcilePlanConfigService
  def perform
    ...
    return if IntelychatHub.pricing_plan != 'community'
  ...
  def remove_premium_config_reset_warning
    Redis::Alfred.delete(Redis::Alfred::INTELYCHAT_INSTALLATION_CONFIG_RESET_WARNING)
  end

  def create_premium_config_reset_warning
    Redis::Alfred.set(Redis::Alfred::INTELYCHAT_INSTALLATION_CONFIG_RESET_WARNING, true)
  end
