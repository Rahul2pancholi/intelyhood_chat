module Enterprise::Account
  ...
  def captain_document_sync_interval(sync_intervals = Enterprise::Account.captain_document_sync_intervals)
    ...
    plan = 'enterprise' if plan.blank? && IntelychatApp.self_hosted_enterprise?
  ...
  def api_and_webhooks_enabled?
    return true unless IntelychatApp.intelychat_cloud?
  ...
  def enable_default_features
    super
    if IntelychatApp.self_hosted_enterprise?
      enable_features('captain_integration', 'captain_integration_v2')
    elsif IntelychatApp.intelychat_cloud?
